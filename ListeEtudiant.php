...
$query_etudiants = "SELECT * FROM utilisateurs WHERE role='etudiant'";
                ...
                <tbody class="body-half-screen">
                    ...
                    if ($result_etudiants->num_rows > 0) {
                        ...
                        while ($row_etudiant = $result_etudiants->fetch_assoc()) {
                            ...
                            echo "<td>" . $row_etudiant['genre'] . "</td>";
                            echo "<td>" . $row_etudiant['datenaissance'] . "</td>";
                            echo "<td>" . $row_etudiant['adresse'] . "</td>";
                            echo "<td>0" . $row_etudiant['telephone'] . "</td>";
                            echo "<td>&nbsp;&nbsp;
                    <a class='editclick' href='#' data-id=" . $row_etudiant['id'] . "><i class='fas fa-edit'></i></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <a class='deleteclick' href='supprimer_etudiant.php?id=" . $row_etudiant['id'] . "'><i class='fas fa-trash-alt'></i></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <a class='SendMail' href='#p' data-id=" . $row_etudiant['id'] . "><i class='fas fa-envelope'></i></a>
    ...
    <div id="addUserModal" class="modal">
        <div class="modal-content">
            ...
            <form action="ajouter_utilisateur.php" method="POST">
                ...
                <label for="role">Rôle:</label> <input type="text" id="role" name="role" value="etudiant" readonly></br>
    ...
    <div id="editUserModal" class="modal">
        <div class="modal-content">
            ...
            <form action="modifier_etudiant.php" method="POST">
                <input type="hidden" id="editUserId" name="id" value="<?php echo $row_etudiant['id']; ?>">
                ...
                <label for="editUserGenre">Genre:</label> <select id="editUserGenre" name="genre">
                    ...
                    foreach ($genres as $genre) {
                        $selected = ($row_etudiant['genre'] == $genre) ? 'selected' : ''; // Vérifier si l'option est sélectionnée
        ...
        $(document).ready(function () {
            ...
            $(".deleteclick").click(function () {
                ...
                if (confirmDelete) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "supprimer_etudiant.php", // L'URL vers votre script PHP de suppression
